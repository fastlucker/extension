...
const AAVELogo: React.FC<Props> = ({ width = 150, height = 40, ...rest }) => (
  <Svg width={width} height={height} viewBox="0 0 800 220" {...rest}>
    <Defs>
      <LinearGradient
        id="linear-gradient"
        x1="402.38"
        ...
        x2="416.27"
        y2="611.26"
        gradientTransform="matrix(55.73, 0, 0, -61.13, -22399.38, 37390.17)"

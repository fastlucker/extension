...
const TransakLogo: React.FC<Props> = ({ width = 152, height = 58, ...rest }) => (
  <Svg width={width} height={height} viewBox="0 0 2160 700" {...rest}>
    <G id="transparent_1_">
      <G id="logo_4_">
        ...
        >
          <Stop offset="0.1304" stopColor="rgb(52, 149, 247)" />
          <Stop offset="0.3063" stopColor="rgb(43, 135, 242)" />
          <Stop offset="0.6392" stopColor="rgb(20, 97, 229)" />
          <Stop offset="0.7232" stopColor="rgb(14, 87, 225)" />
        </LinearGradient>
        <Path
          fill="url(#SVGID_1_)"
          d="M566.4,640.4H175.3c-22,0-39.8-17.8-39.8-39.8V201.5c0-22,17.8-39.8,39.8-39.8h391.2 c22,0,39.8,17.8,39.8,39.8v399.1C606.3,622.5,588.5,640.4,566.4,640.4z"
        />
        <Path fill="#2970E2" d="M606.3,451.6v148.9c0,22-17.8,39.8-39.8,39.8H417.6L606.3,451.6z" />
        <G>
          <G>
            <G>
              <Path
                fill="#D1D9E6"
                d="M293.4,449.7l138.9-144.4c10.6-10.6,27.2-9.8,38.3,1.2l80.3,77.4c8.5,8.2,8.3,24.4,0.4,33.1 c-10.3,10.3-21.9,11-37.5,0.4l-58.2-63L309.3,493.5c-9.8,7.6-19.8,14-35.2,4.1c-5.3-7.1,5.2-21,1.1-25.1L293.4,449.7z"
              />
            </G>
            <G>
              <Path
                fill="#D1D9E6"
                d="M287.1,498.2c-11.9-0.4-21.2-8.1-21.2-17.3l0.7-165.1c0-9.1,8.5-20.2,20.4-20.6 c15.8,0,22.7,12.8,22.7,22.3v163.8C309.8,490.8,299.5,498.5,287.1,498.2z"
              />
            </G>
            <G>
              <Path
                fill="#D1D9E6"
                d="M449.1,502.7c-14.7,0-20.9-10.9-20.9-19.5V331.8c0-8.5,9.1-18.9,20.9-19.3c12.3-0.4,22.5,10,22.5,18.9 v149.7C471.6,491.7,464.3,502.7,449.1,502.7z"
              />
            </G>
          </G>
          <G>
            <G>
              <Path
                fill="#FFFFFF"
                d="M282.1,500c-9.1-0.4-16.2-8.1-16.2-17.3V317.6c0-9.1,7.1-20.2,16.2-20.6c9.5-0.4,17.5,10.6,17.5,20.2v166 C299.6,492.7,291.7,500.4,282.1,500z"
              />
            </G>
            <G>
              <Path
                fill="#FFFFFF"
                d="M444.5,501.7c-9.3,0-16.9-10.8-16.9-20.2V318.9c0-9.3,7.6-16.9,16.9-16.9c9.3,0,16.9,7.6,16.9,16.9v162.7 C461.3,490.8,453.8,501.7,444.5,501.7z"
              />
            </G>
            <G>
              <Path
                fill="#FFFFFF"
                d="M282.8,498.4c-5.5,0-11-2.1-15.1-6.3l-76.5-76.7c-8.3-8.4-8.3-21.9,0.1-30.3c8.4-8.3,21.9-8.3,30.3,0.1 l61.6,62l147.4-140.3c8.3-7.9,21.3-7.9,29.6,0.1l80.2,77.4c8.5,8.2,8.7,21.7,0.6,30.3c-8.1,8.5-21.7,8.7-30.3,0.6l-65.5-63.1 L297.5,492.5C293.4,496.4,288.1,498.4,282.8,498.4z"
              />
            </G>
          </G>
          <Path
            fill="#FFFFFF"
            d="M429.7,378.8l-9.3,8.8c0,0,2.6-14.7-4.9-7.6c-7.6,7.2,11.6-18.2,11.6-18.2l3.9,4.9L429.7,378.8z"
          />
          <Path fill="#FFFFFF" d="M461.3,376.6c0,0,0.5-9,10.3,6.4v-12.1l-10.6-5.5L461.3,376.6z" />
          <Path fill="#FFFFFF" d="M299.7,419.2c0,0,1.4,10,10.2-2.9v12.1l-10.6,5.5L299.7,419.2z" />
        </G>
      </G>
      <LinearGradient
        id="SVGID_2_"

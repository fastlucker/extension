...
import DrawerContent from '@common/config/Router/DrawerContent'
import { headerAlpha, headerBeta, headerGamma } from '@common/config/Router/HeadersConfig'
import styles, {
  horizontalTabBarLabelStyle,
  tabBarItemStyle,
  tabBarLabelStyle,
  tabBarStyle
} from '@common/config/Router/styles'

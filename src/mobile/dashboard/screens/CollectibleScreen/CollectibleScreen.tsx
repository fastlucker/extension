...
import CollectibleLoader from '@mobile/dashboard/components/Loaders/CollectibleLoader'
import handleCollectibleUri from '@mobile/dashboard/helpers/handleCollectibleUri'

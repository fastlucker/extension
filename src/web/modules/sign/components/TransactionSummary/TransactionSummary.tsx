    ...
    <View style={[styles.container, style]}>
      <Pressable onPress={() => setIsExpanded((prevState) => !prevState)}>
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            <Text style={[styles.action, styles.mr5]}>{t('Send')}</Text>
            <Text style={[styles.headerText, styles.mr5]}>10000.0</Text>
            <Image
              source={{
            ...
            />{' '}
            <Text style={[styles.headerText, styles.mr5]}>USDC</Text>
            <Text style={[styles.to, styles.mr5]}>{t('to')}</Text>
            <Text style={styles.headerText}>0x5a2fae94BDaa7B30B6049b1f5c9C86C3E4fd212F</Text>
          </View>
          <View>
      ...
      {isExpanded && (
        <View style={styles.body}>
          ...
          <Text style={styles.bodyText}>{t('Value to be sent (value):')} 0.0 MATIC</Text>
          <Text style={styles.bodyText}>
            {t('Data')}:
